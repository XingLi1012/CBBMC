...
if(1==1):#全局量
    if(1==1):#全局常量
        ...
        #MSR
        PATH_R1='F:\\李兴学术1盘\\01_博士生学术区\\01_人体行为识别\\01_人体行为识别数据库与特征\\02_特征\\01_MSR\\01_深度数据\\04-01-01_DTM_HOG(6轴)(ROI)(10c10&2c2)\\'
        PATH_R2='F:\\李兴学术1盘\\01_博士生学术区\\01_人体行为识别\\01_人体行为识别数据库与特征\\02_特征\\01_MSR\\01_深度数据\\05-01-01_GP3_DMI(ROI)_HOG(10c10&2c2)\\'
        PATH_R0='F:\\李兴学术1盘\\01_博士生学术区\\01_人体行为识别\\01_人体行为识别数据库与特征\\02_特征\\01_MSR\\01_深度数据\\'
        ...
        #UTD
        # PATH_R3='D:\\Desktop\\UTD97.9\\05-01-01_GP3_DMI(ROI)_HOG(10c10&2c2)(去噪)\\'
        # PATH_R2='D:\\Desktop\\UTD97.9\\04-01-01_DTM_HOG(6轴)(ROI)(10c10&2c2)(去噪)\\'
        # PATH_R1='C:\\Users\\lx\\Documents\\Tencent Files\\340299042\\FileRecv\\'#GCN
        # PATH_R0='D:\\Desktop\\UTD97.9\\04-01-01_DTM_HOG(6轴)(ROI)(10c10&2c2)(去噪)\\'
...
if(1==1):#主程序
    ...
    if(1==1):#数据集划分
        if(CROSS_SUBJECT==1):#交叉主题
            ...
            train_X,test_X,train_Y,test_Y=train_test_split(x, y,test_size=TEST_NUM/ALL_SAMPLE_NUM,random_state=0)       
        print('#######################')
